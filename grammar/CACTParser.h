...
public:
  ...
  enum {
    ...
    RuleBlockItem = 16, RuleStmt = 17, RuleElseStmt = 18, RuleExp = 19, 
    RuleCond = 20, RuleIfCond = 21, RuleWhileCond = 22, RuleLVal = 23, RulePrimaryExp = 24, 
    RuleNumber = 25, RuleUnaryExp = 26, RuleUnaryOp = 27, RuleFuncRParams = 28, 
    RuleMulExp = 29, RuleAddExp = 30, RuleRelExp = 31, RuleEqExp = 32, RuleLAndExp = 33, 
    RuleLOrExp = 34, RuleConstExp = 35
  };
